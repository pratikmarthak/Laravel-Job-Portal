                                ...
                                <div class="row">
                                    <div class="col-12 mt-30">
                                        <div class="dash_alert_box p-30 bg-danger rounded-4 d-flex flex-wrap">
                                            <span class="img">
                                                <img src="{{ asset(auth('web')->user()->image) }}" alt="alert">
                                            </span>
                                            <div class="text">
                                                <h4>Please setup your Profile First</h4>
                                                <p>Yoou can not use all the features of the website if you don't setup your profile account first make sure you setup your <b style="font-weight: bold"> Basic ,Profile ,Experience & Education ,Account Settings </b> Date </p>
                                            </div>
