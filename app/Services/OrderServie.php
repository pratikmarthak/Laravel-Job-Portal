...
class OrderServie{
    static function storeOrder(string $transactionId, string $paymentProvider, string $amount, string $paidInCurrency, string $paymentStatus)
    {
        ...
        $order->default_amount = Session::get('selected_plan')['price'] . config('Setting.site_default_currency');
    ...
    static function setUserPlan(){
        ...
        UserPlan::updateOrCreate(
            ...
            [
                ...
                $userPlan->job_limit + Session::get('selected_plan')['job_limit'] : Session::get('selected_plan')['job_limit'],

                'featured_job_limit' => $userPlan?->featured_job_limit ?
                $userPlan->featured_job_limit + Session::get('selected_plan')['feature_job_limit'] :
                Session::get('selected_plan')['feature_job_limit'],
                ...
                'profile_verified' => Session::get('selected_plan')['profile_verify'],
            ]
        );
    }
}
